...
The Forecasting Proficiency Test [FPT\; @Himmelstein_etal_2024] is a test developed to measure forecasting proficiency. The FPT uses *quantile forecast* items:
...
## Assumptions About Item Behavior {visibility="hidden"}
...
**Assumption 1:** On average, items are always biased to some extent (*irreducible uncertainty*) 
...
<li> Items with higher $\sigma_i$ measure more skilled forecasters better. </li>
:::

::: {.fragment fragment-index=2}
<li> Higher $a_i$ implies better measurement within a narrower interval of $\theta$.  </li>
:::
